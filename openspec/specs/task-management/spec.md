...
Gestionar el ciclo de vida completo de tareas en el navegador: crear, listar, editar, eliminar y completar/descompletar, con validaciones de negocio, ordenamiento por prioridad y persistencia en localStorage sin backend.
